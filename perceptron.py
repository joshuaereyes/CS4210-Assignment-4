...
# SPECIFICATION: build a single layer and multi layer perceptron finding best accuracy for each
...
for i in n: #iterates over n
    ...
    for j in r: #iterates over r
        ...
        for a in ['perceptron', 'mlp']: #iterates over the algorithms
            ...
            #--> add your Python code here
            if accuracy > highest_perceptron_accuracy and a == 'perceptron':
                highest_perceptron_accuracy = accuracy
                print(f"Highest Perceptron accuracy so far: {highest_perceptron_accuracy}, Parameters: learning rate= {i}, shuffle={j}")
            elif a == 'mlp' and accuracy > highest_mlp_accuracy:
                 highest_mlp_accuracy = accuracy
                 print(f"Highest MLP accuracy so far: {highest_mlp_accuracy}, Parameters: learning rate= {i}, shuffle={j}")
